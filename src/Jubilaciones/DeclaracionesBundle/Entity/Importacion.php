...
class Importacion {
    ...
    /**
     * @ORM\Column(type="string", length=255, unique=true, columnDefinition="enum('Usuarios','Organismos', 'Representantes', 'Organismo_Representante', 'Usuario_Organismo','Declaraciones_Organismo')")
     * @Assert\NotBlank
     */
    private $nombre;
