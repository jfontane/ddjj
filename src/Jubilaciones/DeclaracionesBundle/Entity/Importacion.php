...
class Importacion {
    ...
    /**
     * @ORM\Column(type="string", length=255, columnDefinition="enum('Usuarios','Organismos', 'Representantes', 'Declaraciones_Organismo', 'ConvenioCuotas_Organismo', 'ConvenioCtaCte_Organismo')")
     * @Assert\NotBlank
     */
    private $nombre;
